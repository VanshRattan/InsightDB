...
# In-memory fallback so uploads/analysis still work if PostgreSQL is unavailable.
...
def create_session(session_id: str, dataset_id: str, dataset_name: Optional[str] = None, user_id: int = 1) -> Dict[str, Any]:
    ...
    query = """
        ...
        RETURNING *;
    """
    record = {"id": session_id, "user_id": user_id, "dataset_id": dataset_id, "dataset_name": dataset_name}
